...
VK_RETURN = 13
VK_SHIFT = 16
VK_CONTROL = VK_CTRL = 17
VK_MENU = VK_ALT = 18
VK_PAUSE = 19
VK_CAPITAL = VK_CAPSLOCK = 20
VK_KANA = 21
...
VK_MODECHANGE = 31
VK_SPACE = 32
VK_PRIOR = VK_PAGEUP = 33
VK_NEXT = VK_PAGEDOWN = 34
VK_END = 35
VK_HOME = 36
VK_LEFT = 37
VK_UP = 38
...
VK_F24 = 135
VK_NUMLOCK = 144
VK_SCROLL = VK_SCRLOCK = 145
VK_LSHIFT = 160
VK_RSHIFT = 161
VK_LCONTROL = VK_LCTRL = 162
VK_RCONTROL = VK_RCTRL = 163
VK_LMENU = VK_LALT = 164
VK_RMENU = VK_RALT = 165
VK_PROCESSKEY = 229
VK_ATTN = 246
VK_CRSEL = 247
VK_EXSEL = 248
...
THREAD_ALL_ACCESS = (THREAD_SUSPEND_RESUME | THREAD_TERMINATE |
                     THREAD_QUERY_INFORMATION | THREAD_SET_INFORMATION |
                     THREAD_GET_CONTEXT | THREAD_SET_CONTEXT | THREAD_SET_THREAD_TOKEN |
                     THREAD_IMPERSONATE | THREAD_DIRECT_IMPERSONATION | SYNCHRONIZE)
MAPVK_VK_TO_VSC = 0
MAPVK_VSC_TO_VK = 1
MAPVK_VK_TO_CHAR = 2
...
VK_MAP_KEYBOARD = {
    ...
    221: ']|}|OEM_6',
    222: '\'|\"|OEM_7',
    # 223: 'OEM_8|用于其他字符;它可以通过键盘而变化。',
    # 224: '保留',
    # 225: '特定OEM',
    # 226: 'OEM_102|<>美国标准键盘上的键，或 \\| 非美国102键键盘上的键',
    # 227: '特定OEM',
    # 228: '特定OEM',
    # 229: 'PROCESSKEY',
    # 230: '特定OEM',
...
VK_MAP = {**VK_MAP_MOUSE, **VK_MAP_KEYBOARD}
VK_ENTER = VK_RETURN
WM_APP = 0x8000
WM_APPEND = 0xbfff
INFINITE = 0xffffffff
